...
// Método seguir un contacto (seguir a otro usuario)
export const saveContact = async (req, res) => {
    try {
        ...
        const contactedUser = await User.findById(contact_user); // Verificar si usuario a seguir existe
...
export const contacting = async (req, res) => {
    try {
        ...
        const contacts = await Contact.paginate({ follower_id: userId }, options);  // Buscar en la BD los usuarios seguidos y popular los datos de los usuarios
...
export const contacts = async (req, res) => {
    try {
      ...
      const options = {
        ...
        limit: itemsPerPage,
        populate: {
          path: 'followed_id', // Cambiado para hacer referencia al modelo correcto
          select: '-password -role -__v -email'
        },
        lean: true
      };
  
      // Buscar en la BD los contactos (seguidores) y popular los datos de los usuarios
